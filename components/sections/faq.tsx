...
const faqs = [
  {
    ...
    answer:
      "Project timelines vary based on scope and complexity. A standard website takes 5-7 days, while custom software or mobile apps can range from 2-4 weeks. We provide a detailed timeline during the discovery phase.",
  },
  {
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          <Reveal>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Have a question not covered here? Reach out to our team — we are
              happy to help.
            </p>
          </Reveal>
